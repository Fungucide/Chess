...
public class Bishop extends Piece {
	...
	public Bishop(PieceName name, int color, Game g, Board board) {
		super(name, color, g, board);
		// TODO Auto-generated constructor stub
	}

	public Bishop(PieceName name, int color, Game g, Board board, int x, int y, boolean moved) throws Exception {
